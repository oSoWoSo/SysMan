...
type xbpsGuiApp struct {
	...
	btnClean   *common.HoverableButton
	buildMode  string // "" = default, "-Q" = with tests, "-C" = with confpkg
	btnBack    *common.HoverableButton
	btnFwd     *common.HoverableButton
	...
	editorBtnSave *common.HoverableButton
	editorBtnLint *common.HoverableButton
	editorBtnSum  *common.HoverableButton
	editorBtnBump *common.HoverableButton
...
func (g *xbpsGuiApp) showAbout() {
	...
	content := container.NewVBox(
		...
		widget.NewSeparator(),
		boldLabel(t("about.version")), widget.NewLabel(serman.Version),
		boldLabel(t("about.author")), widget.NewLabel(serman.AppAuthor),
		boldLabel(t("about.license")), widget.NewLabel(serman.AppLicense),
...
func (g *xbpsGuiApp) buildContent() fyne.CanvasObject {
	...
	checkQ := common.NewHoverableCheck("-Q", t("tooltip.srcman.build_q"), g.statusBar, func(checked bool) {
		if checked {
	...
	checkC := common.NewHoverableCheck("-C", t("tooltip.srcman.build_c"), g.statusBar, func(checked bool) {
		if checked {
